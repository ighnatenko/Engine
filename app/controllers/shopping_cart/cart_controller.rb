...
module ShoppingCart
  ...
  class CartController < ShoppingCart::ApplicationController
    ...
    def change_quantity(increment: true)
      ShoppingCart::ChangeQuantity.call(@order.id, params[:book_id],
                                        increment: increment) do
    ...
    def create_position
      ShoppingCart::Position.create(order_id: @order.id,
                                    book_id: items_params[:book_id],
